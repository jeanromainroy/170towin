<script>
    ...
    export let download_prefix = '170towin';
    ...
    function download(){
        ...
        const filename = `${download_prefix}_${getFormattedDateTime(0)}.csv`;
...
{#if _values !== null }
    ...
    <!-- Download -->
    <div class="download">
        <img alt="download" on:click={() => { download() }} src='/assets/download.png' width=30 height=30/>
    </div>
{/if}
